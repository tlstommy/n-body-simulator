...
export default function Container(){
    ...
    const [bodiesData, setBodiesData] = useState([
        ...
        { x: 1000, y: 400, vX: 0, vY: 0, radius: 15, color: 'blue', mass: setMassVal(6,24), staticBody: false, trail: []},
        { x: 800, y: 400, vX: 0, vY: 0, radius: 15, color: 'green', mass: setMassVal(6,24), staticBody: false, trail: []},
